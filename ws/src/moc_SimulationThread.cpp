/****************************************************************************
** Meta object code from reading C++ file 'SimulationThread.hpp'
**
...
#error "The header file 'SimulationThread.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 34, 7), // "percent"
QT_MOC_LITERAL(4, 42, 12), // "resultsReady"
QT_MOC_LITERAL(5, 55, 7), // "results"
QT_MOC_LITERAL(6, 63, 15), // "simulationError"
QT_MOC_LITERAL(7, 79, 5) // "error"

    },
    "SimulationThread\0progressUpdated\0\0"
    "percent\0resultsReady\0results\0"
    "simulationError\0error"
};
...
void SimulationThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->simulationError((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SimulationThread::resultsReady)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (SimulationThread::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SimulationThread::simulationError)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 1
void SimulationThread::resultsReady(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 2
void SimulationThread::simulationError(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
